		      ...
		      <s:if test="#list!=null && #list.size()>0">
		      	<s:iterator value="#list" status="st">
		      		<tr>
				        ...
				        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><s:property value="curracyLevel"/></div></td>
				        ...
				        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><s:property value="remark"/></div></td>
				     	<td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
								...
								<a href="nonFoodParametersEquipmentAction_delete.action?id=<s:property value="id"/>" >删除</a>
				     	</div></td>
				    </tr> 
		      	</s:iterator>
		      </s:if>
