...
<body>
 	<form action="nonFoodParametersAction_save.action" method="POST">
		    ...
		    <td>
		    	...
		    	<!--<s:hidden name="user.id"></s:hidden>-->
		    		<table>
		    			<tr class="STYLE21">
		    				<td>项目产品序号:</td>
		    				<td><input name="productSeq" cssStyle="width: 200px;"/></td>
		    			</tr>
		    			<tr class="STYLE21">
		    				<td>参数序号:</td>
		    			...
		    			<tr class="STYLE21">
		    				<td>项目（参数）名称:</td>
		    				<td><input name="projectName" cssStyle="width: 200px;"/></td>
		    			</tr>
		    			<tr class="STYLE21">
		    				<td>标准代号:</td>
