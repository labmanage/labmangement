		          ...
		          <tr>
		            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		              <tr>
		                ...
		                <td width="94%" valign="bottom"><span class="STYLE1">食品类参数限值及设备列表</span></td>
		              </tr>
		            </table></td>
		      		...
		      		<tr>
				        ...
				        <td height="20" bgcolor="ffffffFFF" class="STYLE19"><div align="center"><s:property value="remark"/></div></td>
				     	<td height="20" bgcolor="ffffffFFF"><div align="center" class="STYLE21">
								...
								<a class="deleteBtn"  href="foodParametersEquipmentAction_delete.action?id=<s:property value="id"/>" >删除</a>
