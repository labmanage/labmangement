		  ...
		  <tr>
		          ...
		          <tr>
		            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		              <tr>
		                ...
		                <td width="94%" valign="bottom"><span class="STYLE1">角色</span></td>
		              </tr>
		            </table></td>
		   ...
		   <tr>
		        <td height="20" bgcolor="ffffffFFF" class="STYLE10" colspan="8"><div align="left">
					<a href="${pageContext.request.contextPath }/roleAction_toAdd.action">添加角色</a>
				</div></td>
		  </tr>  
		  <tr>
		      		...
		      		<tr>
				        ...
				        <td height="20" bgcolor="ffffffFFF" class="STYLE19"><div align="center"><s:property value="remark"/></div></td>
				     	<td height="20" bgcolor="ffffffFFF"><div align="center" class="STYLE21">
			        			<a href="${pageContext.request.contextPath }/roleAction_toEdit.action?id=<s:property value="id"/>" >编辑</a>
								<a class="deleteBtn"  href="roleAction_delete.action?id=<s:property value="id"/>" >删除</a>
								<a href="roleAction_showUsers.action?id=<s:property value="id"/>" >查看用户</a>
				     	</div></td>
				    </tr> 
		      	</s:iterator>
		      </s:if>
