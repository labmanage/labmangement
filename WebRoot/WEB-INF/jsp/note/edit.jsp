...
<body>
	<form action="noteAction_edit.action" method="post">
	<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()" onmouseout="changeback()">
			...
			<tr>
				<td colspan="16" bgcolor="d3eaef" class="STYLE6">失效时间：
				<s:textfield format="yyyy-MM-dd HH:mm:ss" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true})" name="expireTime" cssStyle="width: 800px;">
					<s:param name="value" ><s:date name="expireTime" format="yyyy-MM-dd HH:mm:ss" /></s:param>
				</s:textfield></td>
			</tr>
			<tr>
				<td colspan="16" bgcolor="d3eaef" class="STYLE6">内容：
					
					<s:textarea id="editor1" name="content" cssStyle="width: 100%;" row="10" />
				</td>
			</tr>
			<tr class="STYLE21">
