		      ...
		      <s:if test="#list!=null && #list.size()>0">
		      	<s:iterator value="#list">
		      		<tr>
				        ...
				        <td height="20" bgcolor="ffffffFFF" class="STYLE19"><div align="center"><s:property value="sampleQuantity"/></div></td>
				        ...
				        <td height="20" bgcolor="ffffffFFF"><div align="center" class="STYLE21">
				        	<s:if test="state==0">
								...
								<a class="deleteBtn"  href="qualityAction_delete.action?id=<s:property value="id"/>" >删除</a>
