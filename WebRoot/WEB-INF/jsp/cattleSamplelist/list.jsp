 	...
 	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		          ...
		          <tr>
		            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		              <tr>
		                ...
		                <td width="94%" valign="bottom"><span class="STYLE1">畜产品抽样单流程列表</span></td>
		              </tr>
		            </table></td>
		  ...
		  <tr>
		        <td height="20" bgcolor="ffffffFFF" class="STYLE10" colspan="8"><div align="left">
					<a href="${pageContext.request.contextPath }/cattleAction_toAdd.action">添加抽样单申请</a>
				</div></td>
		  </tr> 
		  <tr>
		    <td><table class="dataTable" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
		      <tr>
		        ...
		        <td width="20%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">样品名称</span></div></td>
		      ...
		      <s:if test="#list!=null && #list.size()>0">
		      	<s:iterator value="#list">
		      		<tr>
				        ...
				        <td height="20" bgcolor="ffffffFFF" class="STYLE19"><div align="center"><s:property value="company"/></div></td>
				        <td height="20" bgcolor="ffffffFFF" class="STYLE19"><div align="center"><s:property value="legalEntity"/></div></td>
				        <td height="20" bgcolor="ffffffFFF" class="STYLE19"><div align="center"><s:property value="name"/></div></td>
				        <td height="20" bgcolor="ffffffFFF" class="STYLE19"><div align="center"><s:property value="sampleCount"/></div></td>
				        ...
				        <td height="20" bgcolor="ffffffFFF"><div align="center" class="STYLE21">
				        	<s:if test="state==0">
			        			<a href="${pageContext.request.contextPath }/cattleAction_toEdit.action?id=<s:property value="id"/>" >修改</a>
								<a class="deleteBtn" href="cattleAction_delete.action?id=<s:property value="id"/>" >删除</a>
								<a href="${pageContext.request.contextPath }/laboratoryManagementProcessAction_startProcess.action?id=<s:property value="id"/>&processType=1" >申请抽样检查</a>
			        		</s:if>
			 				<s:elseif test="state==1">
